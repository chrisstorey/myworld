...
def create_person(My_World_premise_ID: str, type_of_person: str, gender: str, married: bool):
    ...
    return My_World_premise_ID, My_World_person_ID, \
           nationality, first_name, \
           last_name, type_of_person, dob
